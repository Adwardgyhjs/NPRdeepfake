...
```bash
python train.py --train-file "BLAH_BLAH/91-image_x3.h5" --eval-file "BLAH_BLAH/Set5_x3.h5" --outputs-dir "BLAH_BLAH/outputs" --scale 3 --lr 1e-4 --batch-size 16 --num-epochs 400 --num-workers 8 --seed 123
```
